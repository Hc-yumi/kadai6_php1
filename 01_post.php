...
<form action="02_write.php" method="post">
  <table border='2' class="input_area">
    <tr>
      <th>名前</th>
      <th>MAIL</th>
      <th>今 居住地</th>
    ...
    <tr>
      <td> <p class = "input_name"><input type="text" name="name" size="20"></p></td>
      <td> <p class= "input_mail" ><input type="text" name="mail" size="20"></p></td>
      <td><p class= "input_live" ><input type="text" name="live" size="20"></p></td>
    </tr>
